...
<head>
	...
	<title>Modal | Azzara Bootstrap Dashboard</title>
				...
				<div class="container-fluid">
					<div class="card card-documentation">
						...
						<div class="card-body">
								...
								<ul>
									<li>
										...
										<ol>
											...
											<li>
												<a href="#scrollinglong">Scrolling long content</a>
											</li>
											<li>
												<a href="#verticallycentered">Vertically centered</a>
											</li>
											<li>
												<a href="#embed">Embedding YouTube videos</a>
											</li>
										</ol>
									</li>
									<li>
										<a href="#optional">Optional sizes</a>
									</li>
									<li>
										<a href="#usage">Usage</a>
										<ol>
											<li>
												<a href="#viadata">Via data attributes</a>
											</li>
											<li>
												<a href="#viajs">Via JavaScript</a>
											</li>
											<li>
							...
							<h4 class="subcontent-title" id="examples">
								<span>Examples</span>
							</h4>
							<h5 id="modalcomponents">Modal components</h5>
...
&lt;/div&gt;
							...
							<h5 id="scrollinglong">Scrolling long content</h5>
...
&lt;/div&gt;
							...
							<h5 id="verticallycentered">Vertically centered</h5>
...
&lt;/div&gt;
							...
							<h5 id="embed">Embedding YouTube videos</h5>
							...
							<h4 class="subcontent-title" id="optional"><span>Optional sizes</span></h5>
...
&lt;/div&gt;
								...
								<h4 class="subcontent-title" id="usage"><span>Usage</span></h4>
								...
								<h5 id="viadata">Via data attributes</h5>
